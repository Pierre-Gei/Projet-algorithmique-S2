...
void gestionEvenement(EvenementGfx evenement)
{
	...
	case Temporisation:
		if (new_sim == 1)
		{
			...
			setTab(tabPlanete, 10, "PSP", (double)685, (double)6.150099824120720E+10, (double)0.001, 125, 125, 125, 2.480492082498334E+10, -5.623332788775445E+10, 3.828529362470469E+04, -2.618792274253275E+04, "Sonde");
