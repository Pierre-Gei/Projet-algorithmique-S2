...
void gestionEvenement(EvenementGfx evenement)
{
	...
	case Temporisation:
		if (new_sim == 1)
		{
			...
			setTab(tabPlanete, 11, "voyager2", (double)722, (double)1.951421713161150E+13, (double)0.001, 125, 125, 125, 5.395883881531995E+12, -1.450898056059902E+13, 4.228713829442690E+03, -9.351932312118578E+03, "Sonde");
